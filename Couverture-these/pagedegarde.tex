...
\logoecoledoc{./Couverture-these/ecoles-doctorales/MathSTIC/logo-mathSTIC} %logo ecole doctorale
...
\ecoledoc{\'{E}cole Doctorale \No 601}
...
\AddToShipoutPicture*{%
    ...
    \parbox[b][42.5cm]{\paperwidth}{%
        \vfill
        \includegraphics[width=\paperwidth,keepaspectratio]{./Couverture-these/ecoles-doctorales/MathSTIC/image-fond-MATHSTIC-garde.pdf}% image de fond UR1
        \vfill
}}}
