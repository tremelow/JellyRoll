...
\date{08/12/2021\smallskip}
\lieu{Rennes}

%Indiquer le nom du (ou des) laboratoire (s) dans le(s)quel(s) le travail de th\`{e}se a \'{e}t\'{e} effectu\'{e}, indiquer aussi si souhait\'{e} le nom de la (les) facult\'{e}(s) (UFR, \'{e}cole(s), Institut(s), Centre(s)...), son (leurs) adresse(s)... 
%Indicates the name (or names) of research laboratories where the work has been done as well as (if desired) the names of faculties (UFR, Schools, institution...
\uniterecherche{\parbox[t]{\linewidth}{Inria, Centre Inria Rennes-Bretagne Atlantique 
\smallskip\\ 
...
{\color{gray}Rapporteurs :}           
    ...
    & Katharina \textsc{Schratz} & Professeur des universités -- Sorbonne Université 
\medskip\\
% Pr\'{e}sident :         & François \textsc{Castella} & Professeur des universités -- Université de Rennes 1 \\
...
\vspace*{1cm}
% Co-dir. de th\`{e}se : & Mohammed \textsc{Lemou}    & Fonction et \'{e}tablissement d'exercice \textit{(si pertinent)} \\
\end{tabular}
